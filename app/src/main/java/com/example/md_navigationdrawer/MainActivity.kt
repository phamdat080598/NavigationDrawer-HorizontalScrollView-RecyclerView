...
class MainActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener,MyAdapter.OnClickItem {
    ...
    fun createData(){
        ...
        for(i in 1..10){
            val model = model(i.toString(),"hjgasfgasfgyasdjfgsadjhfgasdhfhgasjfjvhasjfgvasdjfvasdfvhasdfha","a","a","a","a","a","a")
            list.add(model)
        }
    }
    fun createNavigationDawer(){
        ...
        val toggle=ActionBarDrawerToggle(this@MainActivity,drawerLayout,toolbar,R.string.drawer_open,R.string.drawer_close)
